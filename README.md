...
В версии 1.3.0.7: 
 ...
 1) Парсинг цены в WB: сайт 15 секунд тратит на выдачу цены, когда ее 3 шт(колшеле, старая, оригинал) и не всегда берет правильную цену(явно разработчики DCOM грузят медленно), 6 секунд на цену из 2 шт (кошелек и старая) и 4 секунды когда просто одна цена. Это кошмар и АД(!!!)
